echo "===========================================================";
echo "=== WELCOME TO THE FASTEST DIGITAL OCEAN SETUP FOR LAMP ===";
echo "===========================================================";
echo " ";
...
mv files/site.main /etc/apache2/sites-available/$DOMAIN.conf
mv files/site.staging /etc/apache2/sites-available/staging.$DOMAIN.conf

# ENABLE SITES
sudo rm /etc/apache2/sites-enabled/000-default.conf
sudo ln -s /etc/apache2/sites-available/$DOMAIN /etc/apache2/sites-enabled/
sudo ln -s /etc/apache2/sites-available/staging.$DOMAIN /etc/apache2/sites-enabled/
